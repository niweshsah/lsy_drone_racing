...
def export_spatial_drone_model(drone_params: dict):
    ...
    # Spatial States
    s = ca.SX.sym('s')
    w1 = ca.SX.sym('w1'); w2 = ca.SX.sym('w2')
    ds = ca.SX.sym('ds')
    dw1 = ca.SX.sym('dw1'); dw2 = ca.SX.sym('dw2')
...
# ==============================================================================
class SpatialMPC:
    def __init__(self, N=20, Tf=1.0, max_thrust=None, tunnel_radius=0.4, safety_margin=0.05, v_target=5.0):
        self.N = N
        self.Tf = Tf
