...
class TrajectoryGenerator:
    ...
    def generate_spline(self):  # noqa: ANN201, D102
        ...
        path_points = self._add_detour_logic(
            path_points, self.gates_pos, self.gate_normals, self.gate_y_axes, self.gate_z_axes
        )
    ...
    def _determine_detour_direction(self, v_proj, v_proj_norm, y_axis, z_axis):  # noqa: ANN001, ANN202
        ...
        if -90 <= angle_deg < 45:
            return y_axis  # noqa: E701
        elif 45 <= angle_deg < 135:
            return z_axis  # noqa: E701
        else:
            return -y_axis  # noqa: E701

    def _add_detour_logic(
        ...
        for i in range(num_gates - 1):
            ...
            if first_idx_next >= len(pts_list):
                break  # noqa: E701
            ...
            if np.arccos(np.clip(cos_a, -1, 1)) * 180 / np.pi > angle_deg:
                ...
                detour_vec = self._determine_detour_direction(
...
def plot_gate_3d(ax, center, rpy, size=0.5):  # noqa: ANN001
    ...
    poly = Poly3DCollection(
        [global_corners], alpha=0.2, facecolors="cyan", edgecolors="blue", linewidths=2
    )
