...
class SpatialMPC:
    def __init__(
        ...
        self.max_thrust = (
            self.drone_params["thrust_max"] * 4.0 if max_thrust is None else max_thrust
        )
        self.min_thrust = (
            self.drone_params["thrust_min"] * 4.0 if min_thrust is None else min_thrust
        )
